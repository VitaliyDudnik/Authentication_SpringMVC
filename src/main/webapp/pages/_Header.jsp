        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <c:if test="${sessionScope.user != null }">
                    <li class="nav-item">
                        <a class="nav-link active" style="color: floralwhite" aria-current="page"
                           href="${pageContext.request.contextPath}/users/regContent">Home</a>
                    </li>
                </c:if>
                <c:if test="${sessionScope.user == null}">
                    <li class="nav-item">
                        <a class="nav-link active" style="color: floralwhite" aria-current="page"
                           href="${pageContext.request.contextPath}/users/home">Home</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/users/authorization">Sign in</a></li>
                            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/users/reg">Registration</a></li>
                            <li>
                ...
                <c:if test="${sessionScope.user != null}">
                    <li class="nav-item">
                        <a class="nav-link active" style="color: floralwhite" aria-current="page"
                           href="${pageContext.request.contextPath}/users/account">Account</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" style="color: floralwhite" aria-current="page"
                           href="${pageContext.request.contextPath}/calculator/calc">Calculator</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disabled" href="#" tabindex="-1"
                           aria-disabled="true">${welcome}</a>
